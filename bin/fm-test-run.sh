...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-rovo-harness.test.sh|fm-agy-harness.test.sh|\
    fm-omp-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
